...
{
  @override
  State<seg> createState()=>_seg();
}
class _seg extends State<seg> {
  String? result;
  final picker=ImagePicker();
  File? img;
  String? output_image;
  var url="https://1838-156-211-12-168.ngrok-free.app/upload";
  ...
  upload()async
  {
    ...
    request.files.add(http.MultipartFile("file",img!.readAsBytes().asStream(),img!.lengthSync(),
    ...
    if(myRequest.statusCode==200){
      ...
      output_image= resJson["output_image"];
              ...
              Center(
                  ...
                  Text('THE MODEL HAS NOT BEEN PREDICTED',textAlign: TextAlign.center,
                    style: TextStyle(color: Constants.kWhiteColor.withOpacity(0.85,),fontSize: screenHeight<= 667 ? 18 : 34,
                      ...
                      :
                  Text('Result from Model',textAlign: TextAlign.center,
                    style: TextStyle(color: Constants.kWhiteColor.withOpacity(0.85,),fontSize: screenHeight<= 667 ? 18 : 34,
                      fontWeight: FontWeight.w700,),
                  )
